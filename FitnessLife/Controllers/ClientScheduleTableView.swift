...
class ClientScheduleTableView: UITableViewController {
...
//
//        let lesson = schedule[indexPath.row].lesson
//        let date = schedule[indexPath.row].date
